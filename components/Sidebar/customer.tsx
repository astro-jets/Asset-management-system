...
import { IoCarSportSharp, IoFolderOpenOutline, IoFolderOpenSharp, IoSettings } from "react-icons/io5";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/" className="w-[176px] h-[32px]">
          <Image
            width={176}
            height={32}
            src={"/images/logo.png"}
            alt="Logo"
            priority
            className="object-cover overflow-hidden h-[34px] bg-white rounded-2xl"
          />
            ...
            <ul className="mb-6 flex flex-col gap-7.5">
              ...
              <li>
                ...
                >
                  {pathname.includes("assets") ?
                    <IoFolderOpenOutline size={20} color={'orangered'} /> :
              ...
              <li>
                ...
                >
                  ...
                  {pathname.includes("maintenances") ?
                    <BsTools size={20} color={'orangered'} /> :
                    <BsTools size={20} color={'#fff'} />}
                  Maintenances
                </Link>
              </li>
